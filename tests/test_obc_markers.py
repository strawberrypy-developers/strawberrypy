...
def test_local_chern_marker_haldane_tbmodels_pythtb():
    ...
    assert np.allclose(
        hmodel_ptb_finite.hamiltonian.toarray(), hmodel_tbm_finite.hamiltonian.toarray()
    )
...
def test_localization_marker_kane_mele_tbmodels_pythtb():
    ...
    assert np.allclose(rdense_ptb, rdense_tbm)
    assert np.allclose(
        kmmodel_ptb_finite.hamiltonian.toarray(), kmmodel_tbm_finite.hamiltonian.toarray()
    )
