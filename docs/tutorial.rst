...
First, we need to initialize the system through WannierBerri class :python:`System_w90`. For doing this, `.chk` and `.eig` files from Wannier90 are required. Set spin=True if file `.spn` is provided.
