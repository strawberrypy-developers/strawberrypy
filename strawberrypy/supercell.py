...
class Supercell(Model):
    ...
    It contains methods to add disorder and vacancies to the supercell and to calculate single-point topological invarinats.
    ...
    def _pszp_matrix (self, un0 = None):
    ...
    def _dual_state(self, un0, unb, spin = None, n_sub = None):
