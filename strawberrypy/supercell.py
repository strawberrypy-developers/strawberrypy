...
class Supercell(Model):
    ...
    It also can receive as input a model which is initialized as WannierBerri instance :python:`wannierberri.System_w90` from the Wannier functions generated by Wannier90 code starting from a :math:`\Gamma`-only :math:`\textit{ab-initio}` calculation.
    ...
    ----------
        tbmodel : 
            Tight-binding model constructed from TBmodels or PythTB, or :math:`\textit{ab-initio}` tight-binding model inizialized as :python:`wannierberri.System_w90` from WannierBerri.
        Lx :
        ...
        file_spn :
            Whether the file seedname.spn is provided if the model is obtained from Wannier functions generated by Wannier90 code starting from a :math:`\Gamma`-only :math:`\textit{ab-initio}` calculation. Default is :python:`False`.
        n_occ :
            Number of occupied states. This information is required *only* if the model is obtained from Wannier functions generated by Wannier90 code starting from a :math:`\Gamma`-only :math:`\textit{ab-initio}` calculation. Otherwise, half-filling is automatically assumed.
    ...
    def _make_supercell(self, model):
        ...
        For :math:`\textit{ab-initio}` tight-binding model, the model is expected to be provided already in a supercell (:math:`Gamma`-only :math:`\textit{ab-initio}` calculation). 
